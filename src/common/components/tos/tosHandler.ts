...
let tosHandler: TosHandler | undefined;

export function getTosHandler(): TosHandler {
  if (tosHandler === undefined) {
    tosHandler = createTosHandler();
  }
  return tosHandler;
}

function createTosHandler(): TosHandler {
